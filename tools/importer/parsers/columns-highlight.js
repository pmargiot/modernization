 ...
 * Source: https://www.covista.com/ (.block__inline-blockcomponent-card)
 ...
 * Source is a two-column card: media (image) on one side, content (heading/text/CTA) on the other.
 */
export default function parse(element, { document }) {
  ...
  // Column 1: image. Column 2: text content + CTA.
  const imageCol = [];
